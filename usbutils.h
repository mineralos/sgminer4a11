...
#define USB_PARSE_COMMANDS(USB_ADD_COMMAND) \
    ...
    USB_ADD_COMMAND(C_GET_STATUS, "GetStatus") \
    USB_ADD_COMMAND(C_GET_INFO, "GetInfo") \
    USB_ADD_COMMAND(C_SET_IDLE, "SetIdle") \
    USB_ADD_COMMAND(C_SET_ALGO, "SetAlgorithm") \
    USB_ADD_COMMAND(C_GET_CORE, "GetCoreNum") \
    USB_ADD_COMMAND(C_SET_TARGET, "SetTarget") \
    USB_ADD_COMMAND(C_SET_HWRESET, "SetHWReset") \
    USB_ADD_COMMAND(C_SET_STOP_MINER, "SetStopMiner") \
    USB_ADD_COMMAND(C_SET_START_MINER, "SetStartMiner")
