 ...
 int inno_preinit(struct A1_chain *a1, int chain_id)
{
	...
	switch(chain_id){
		case 0:ret = prechain_detect(a1, A1Pll1);break;
		case 1:ret = prechain_detect(a1, A1Pll2);break;
		case 2:ret = prechain_detect(a1, A1Pll3);break;
