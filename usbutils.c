...
#ifdef WIN32
#define LTCTECH_TIMEOUT_MS  999
#define COINFLEX_TIMEOUT_MS  999
...
#ifdef USE_COINFLEX
static struct usb_epinfo cfx_epinfos[] = {
    { LIBUSB_TRANSFER_TYPE_BULK, 64, EPI(1), 0, 0 },
#if 1   /* SAM3U */
    { LIBUSB_TRANSFER_TYPE_BULK, 64, EPO(2), 0, 0 }
#else   /* STM32 */
...
static struct usb_intinfo cfx_ints[] = {
    USB_EPS(1, cfx_epinfos),
    USB_EPS(0, cfx_epinfos)
};
#endif
...
static struct usb_find_devices find_dev[] = {
...
#ifdef USE_COINFLEX
    {
		...
		.idVendor		= 0x03EB,
		.idProduct	= 0x2404,
        	.iManufacturer	= "CoinFlex",
		.iProduct		= "CFX Miner",
		.config		= 1,
		.timeout		= COINFLEX_TIMEOUT_MS,
		.latency		= LATENCY_UNUSED,
		INTINFO(cfx_ints)
	},
#endif
